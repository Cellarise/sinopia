...
function Config(config) {
	...
	for (i in this.uplinks) {
        if(this.uplinks.hasOwnProperty(i)){
            check_user_or_uplink(i);
        }
    }
	...
	if (this.ignore_latest_tag === null) {
        this.ignore_latest_tag = false;
    }
...
function allow_action(pkg, who, action) {
	return (this.get_package_setting(pkg, action) || []).reduce(function(prev, curr) { //jshint ignore:line
		if (curr === String(who) || curr === 'all') {
            return true;
        }
		return prev;
	}, false);
...
Config.prototype.allow_access = function(pkg, user) {
	return allow_action.call(this, pkg, user, 'allow_access') || allow_action.call(this, pkg, user, 'access');
};

Config.prototype.allow_publish = function(pkg, user) {
	return allow_action.call(this, pkg, user, 'allow_publish') || allow_action.call(this, pkg, user, 'publish');
};

Config.prototype.proxy_access = function(pkg, uplink) {
	return allow_action.call(this, pkg, uplink, 'proxy_access') || allow_action.call(this, pkg, uplink, 'proxy');
};

Config.prototype.proxy_publish = function(pkg, uplink) {
	return allow_action.call(this, pkg, uplink, 'proxy_publish');
};

Config.prototype.get_package_setting = function(pkg, setting) {
    var i;
	for (i in this.packages) {
